...
输入文件：input/prompt.txt
我一般使用grok获取一个专业内容的讲稿：
```
<你要讨论的议题>请搜索互联网寻找真相。请帮我生成一份10页的讲话稿，内容要适合网红博主<你的名字>口头讲的，要吸引人，要口语化。第一页是导入，最后一页是感谢。每一页用\n---\n分隔，每一页的内容只包含需要讲的内容，不要有其他脚本、标题内容

生成的内容样例参见assets目录下的prompt.txt
